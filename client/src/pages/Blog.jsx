    ...
    <div className='relative'>
      ...
      <Navbar/>
        <div className='text-center mt-20 text-gray-600'>
          ...
          border-primary/35 bg-primary/5 font-medium text-primary'>Caroline Forbes</p>
        </div>
        ...
        <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
          ...
          <div className='rich-text max-w-3xl mx-auto' dangerouslySetInnerHTML={{__html: data.description}}>
           ...
           <div className='mt-14 mb-10 max-w-3xl mx-auto'>
            <p className='fony-semibold mb-4'>Comments ({comments.length})</p>
           ...
           <div className='my-24 max-w-3xl mx-auto'>
            ...
            <div className='flex'>
              ...
              <img src={assets.twitter_icon} width={50} alt='facebook' />
              <img src={assets.googleplus_icon} width={50} alt='facebook' />
            </div>
           </div>
        </div>
        <Footer />
